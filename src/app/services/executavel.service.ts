...
export class ExecutavelService {
  private executaveis: Executavel[] = [
    new Executavel(1, 'Gerar relatório de vendas da semana',
      'Gerar relatório em formato XLSX de vendas da semana e salva na pasta \'Meus documentos\'',
      'TaskGerarRelatorioSemanal',
      [
        new Parametro('nomeRelatório', 'Relatório Vendas Semanal'),
        new Parametro('dataIniciao', '28/09/2020'),
      ]),
    new Executavel(2, 'Atualizar os dados do painel de BI',
      'Atualizar o painel de BI com os últimos dados produzidos pelo sistema',
